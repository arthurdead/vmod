...
namespace vmod
{
	...
	bool squirrel_preprocessor::initialize() noexcept
	{
		...
		add_define("GSDK_ENGINE_BRANCH_2007"sv, GSDK_ENGINE_BRANCH_2007);
		add_define("GSDK_ENGINE_BRANCH_2007_V0"sv, GSDK_ENGINE_BRANCH_2007_V0);
		add_define("GSDK_ENGINE_BRANCH_2007_V1"sv, GSDK_ENGINE_BRANCH_2007_V1);
		add_define("GSDK_ENGINE_BRANCH_2007_V2"sv, GSDK_ENGINE_BRANCH_2007_V2);

		add_define("GSDK_ENGINE_BRANCH_2010"sv, GSDK_ENGINE_BRANCH_2010);
		add_define("GSDK_ENGINE_BRANCH_2010_V0"sv, GSDK_ENGINE_BRANCH_2010_V0);
		add_define("GSDK_ENGINE_BRANCH_2010_V1"sv, GSDK_ENGINE_BRANCH_2010_V1);
