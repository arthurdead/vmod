...
//#define GSDK_ENGINE_VSCRIPT_BRANCH_V0 0
//#define GSDK_ENGINE_VSCRIPT_BRANCH_V1 1
//#define GSDK_ENGINE_VSCRIPT_BRANCH_V2 2

#if GSDK_ENGINE == GSDK_ENGINE_TF2
	#define GSDK_ENGINE_BRANCH         GSDK_ENGINE_BRANCH_2007
	#define GSDK_ENGINE_BRANCH_VERSION GSDK_ENGINE_BRANCH_2007_V2
	//#define GSDK_VSCRIPT_BRANCH        GSDK_ENGINE_VSCRIPT_BRANCH_V2
	...
	//#define GSDK_VSCRIPT_BRANCH        GSDK_ENGINE_VSCRIPT_BRANCH_V0
#elif GSDK_ENGINE == GSDK_ENGINE_PORTAL2
	#define GSDK_ENGINE_BRANCH         GSDK_ENGINE_BRANCH_2010
	#define GSDK_ENGINE_BRANCH_VERSION GSDK_ENGINE_BRANCH_2010_V1
	//#define GSDK_VSCRIPT_BRANCH        GSDK_ENGINE_VSCRIPT_BRANCH_V1
#else
	#error
#endif
